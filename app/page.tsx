...
export default function Home() {
  ...
  return <main>
    <aside className="sidebar">
      ...
      <nav aria-label="Main navigation"><a className="active" href="#top">⌂ <span>Overview</span></a><a href="#month">✓ <span>Payments</span></a><a href="#debts">◫ <span>Debts</span></a><a href="#history">↙ <span>History</span></a></nav>

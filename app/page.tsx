...
export default function Home() {
  ...
  return <main>
    ...
    <section className="content" id="top">
      <header><div><p className="eyebrow">OVERVIEW</p><h1>Your {monthLabel(selectedMonth)} plan</h1><p>See what’s coming in, what needs to be paid, and how much is safely available for debt.</p></div><div className="header-actions"><button className="primary-button" onClick={() => setModal("income")}>＋ Add income</button><details className="more-menu"><summary>••• More</summary><div><InstallAppButton/><button onClick={exportBackup}>Export backup</button><button onClick={() => restoreInput.current?.click()}>Restore backup</button></div></details><input ref={restoreInput} type="file" accept="application/json" hidden onChange={restoreBackup}/></div></header>
